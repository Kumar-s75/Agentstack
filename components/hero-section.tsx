            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    <span className="text-foreground font-bricolage text-sm">
                ...
                <TextEffect
                  ...
                  delay={0.5}
                  as="p"
                  className="mx-auto mt-4 sm:mt-6 max-w-2xl text-balance text-base sm:text-lg md:text-xl leading-relaxed text-center px-4 sm:px-0"
                >
       Transform your workflow with AgentStack’s AI agents.
Automate tasks, generate insights, and scale your business 10x faster with intelligent precision.
                </TextEffect>
